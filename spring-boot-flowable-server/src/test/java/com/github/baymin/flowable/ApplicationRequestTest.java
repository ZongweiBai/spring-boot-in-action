...
//                .addClasspathResource("application-upcart-flow.bpmn20.xml")
//                .deploy();
//
...
//                runtimeService.startProcessInstanceByKey("application-upcart-flow", variables);
        ...
        for (int i=0; i<tasks.size(); i++) {
            System.out.println((i+1) + ") " + tasks.get(i).getProcessInstanceId() + " " + tasks.get(i).getName());
        }
