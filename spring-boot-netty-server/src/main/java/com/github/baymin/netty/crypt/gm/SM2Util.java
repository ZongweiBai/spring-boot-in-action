...
public class SM2Util extends GMBaseUtil {
     ...
     * @throws Exception
     */
    public static com.github.baymin.netty.crypt.gm.SM2Cipher parseSM2Cipher(byte[] cipherText) throws Exception {
     ...
     * @return
     */
    public static com.github.baymin.netty.crypt.gm.SM2Cipher parseSM2Cipher(Mode mode, byte[] cipherText) throws Exception {
        int curveLength = BCECUtil.getCurveLength(DOMAIN_PARAMS);
     ...
     * @throws Exception
     */
    public static com.github.baymin.netty.crypt.gm.SM2Cipher parseSM2Cipher(
     ...
     * @return
     */
    public static com.github.baymin.netty.crypt.gm.SM2Cipher parseSM2Cipher(Mode mode, int curveLength, int digestLength,
        ...
        com.github.baymin.netty.crypt.gm.SM2Cipher result = new com.github.baymin.netty.crypt.gm.SM2Cipher();
        result.setC1(c1);
        result.setC2(c2);
        result.setC3(c3);
