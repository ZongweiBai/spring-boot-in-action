...
public class BCECUtil {
     ...
     * @param domainParameters EC Domain参数，一般是固定的，如果是SM2算法的可参考{@link com.github.baymin.netty.crypt.gm.SM2Util#DOMAIN_PARAMS}
     * @return
     */
     ...
     * @param x                大数形式的公钥x分量
     * @param y                大数形式的公钥y分量
     * @param curve            EC曲线参数，一般是固定的，如果是SM2算法的可参考{@link com.github.baymin.netty.crypt.gm.SM2Util#CURVE}
     * @param domainParameters EC Domain参数，一般是固定的，如果是SM2算法的可参考{@link com.github.baymin.netty.crypt.gm.SM2Util#DOMAIN_PARAMS}
     * @return
     */
    ...
    public static byte[] convertECPrivateKeySEC1ToPKCS8(byte[] sec1Key) throws IOException {
         ...
         */
        X962Parameters params = getDomainParametersFromName(com.github.baymin.netty.crypt.gm.SM2Util.JDK_EC_SPEC, false);
